...
import MarkLevisonHeadshot300x400Transparent from 'src/content/page/advanced-certified-scrummaster-acsm-training/images/Mark-Levison-headshot-300x400-transparent.png';
import HeadshotBernieMaloney from 'src/content/page/advanced-certified-scrummaster-acsm-training/images/headshot-Bernie-Maloney.png';
import HeadshotAnilJaising from 'src/content/page/advanced-certified-scrummaster-acsm-training/images/headshot-Anil-Jaising.png';
...
<Figure
  src={HeadshotBernieMaloney}
  alt="Bernie Maloney"
  caption="Bernie Maloney"
/>
...
<Figure
  src={HeadshotAnilJaising}
  alt="Anil Jaising"
  caption="Anil Jaising"
/>
