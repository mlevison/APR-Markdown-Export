...
import StoryOfASprintUsersStories1024x577 from 'src/content/page/the-story-of-a-sprint/images/Story_of_a_Sprint_-Users-Stories-1024x577.jpg';
import StoryOfASprintSprintReview1024x578 from 'src/content/page/the-story-of-a-sprint/images/Story_of_a_Sprint_-Sprint-Review-1024x578.jpg';
import StoryOfASprintRetrospective1024x577 from 'src/content/page/the-story-of-a-sprint/images/Story_of_a_Sprint_-Retrospective-1024x577.jpg';
...
<Figure
  src={StoryOfASprintUsersStories1024x577}
  alt="Story of a Sprint - User Stories become product backlog"
  caption="Story of a Sprint - User Stories become product backlog"
/>
...
<Figure
  src={StoryOfASprintSprintReview1024x578}
  alt="Story of a Sprint - Sprint Review"
  caption="Story of a Sprint - Sprint Review"
/>
...
<Figure
  src={StoryOfASprintRetrospective1024x577}
  alt="Story of a Sprint - Sprint Retrospective"
  caption="Story of a Sprint - Sprint Retrospective"
/>
