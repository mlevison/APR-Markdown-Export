...
import IconFacebookByFreepikStarline from 'src/content/page/contact-us/images/icon-Facebook-by-Freepik-Starline.png';
...
<Figure
  src={IconFacebookByFreepikStarline}
  alt="Facebook icon by Starline/ Freepik"
  caption="Facebook icon by Starline/ Freepik"
/>
](https://www.facebook.com/agilepainrelief)[![RSS icon by Starline/ Freepik](src/content/page/contact-us/images/icon-RSS-by-Freepik-Starline.png)](https://feeds.feedburner.com/NotesFromAToolUser)[![LinkedIn icon by Starline/ Freepik](src/content/page/contact-us/images/icon-LinkedIn-by-Freepik-Starline.png)](https://www.linkedin.com/in/marklevison)
