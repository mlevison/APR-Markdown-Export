...
import ScrumAloneNotEnoughPortfolioManagement from 'src/content/blog/portfolio-management-idle-teams/images/scrum-alone-not-enough-portfolio-management.jpg';


<Figure
  src={ScrumAloneNotEnoughPortfolioManagement}
  alt="Beyond Scrum: Scrum Alone Is Not Enough - portfolio management"
  caption="Beyond Scrum: Scrum Alone Is Not Enough - portfolio management"
/>
