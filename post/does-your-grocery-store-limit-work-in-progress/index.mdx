...
import Photodune4373665GroceryStoreXs from 'src/content/blog/does-your-grocery-store-limit-work-in-progress/images/photodune-4373665-grocery-store-xs.jpg';


<Figure
  src={Photodune4373665GroceryStoreXs}
  alt="Grocery store - image licensed from Photodune"
  caption="Grocery store - image licensed from Photodune"
/>
