...
import Photodune1947327BusinessManAngryForComputerCrashXs from 'src/content/blog/early-feedback-reduces-anger-and-frustration/images/photodune-1947327-business-man-angry-for-computer-crash-xs.jpg';


<Figure
  src={Photodune1947327BusinessManAngryForComputerCrashXs}
  alt="business man angry for computer crash - licensed from Photodune"
  caption="business man angry for computer crash - licensed from Photodune"
/>
 Have you seen a developer react after they've spent three days writing a feature, only to have the tester say, "Um... no" in a [Post Mortem](/blog/agile-retrospectives) (a meeting about a project after it has finished) that went badly wrong - with lots of finger pointing and anger?
