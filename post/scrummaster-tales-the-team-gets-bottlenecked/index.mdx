...
import Photodune510956BottleXs from 'src/content/blog/scrummaster-tales-the-team-gets-bottlenecked/images/photodune-510956-bottle-xs.jpg';


<Figure
  src={Photodune510956BottleXs}
  alt="Old fashioned glass bottle with cork stopper. - image licensed from Photodune"
  caption="Old fashioned glass bottle with cork stopper. - image licensed from Photodune"
/>
It's day four of the sprint and ScrumMaster Steve is studying the Story + Task wall to see how the sprint is progressing. After a few minutes he sees three things that standout:
