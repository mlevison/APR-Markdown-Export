...
import 800pxUnitedAirlines777N797UA from 'src/content/blog/what-united-can-teach-us-about-building-systems/images/800px-United_Airlines_777_N797UA.jpg';
import StochasticQueueingQueueLengthCreatedByDavidLevinson from 'src/content/blog/what-united-can-teach-us-about-building-systems/images/StochasticQueueingQueueLength-created-by-David-Levinson.png';


<Figure
  src={800pxUnitedAirlines777N797UA}
...
<Figure
  src={StochasticQueueingQueueLengthCreatedByDavidLevinson}
  alt="Stochastic Queueing, by David Levinson. CC BY-SA 3.0"
  caption="Stochastic Queueing, by David Levinson. CC BY-SA 3.0"
/>
 [Stochastic Queueing](external:https://en.wikibooks.org/wiki/Fundamentals_of_Transportation/Queueing#/media/File:StochasticQueueingQueueLength.png), by David Levinson. [CC BY-SA 3.0](external:https://creativecommons.org/licenses/by-sa/3.0/legalcode)\[/caption\]
