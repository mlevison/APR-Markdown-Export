...
import ExampleMapping from 'src/content/blog/example-mapping-your-secret-weapon-for-effective-acceptance-criteria/images/Example-Mapping.jpg';
...
<Figure
  ...
  caption="Example Mapping sample"
/>
