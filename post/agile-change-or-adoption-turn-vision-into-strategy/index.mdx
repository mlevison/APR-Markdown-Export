...
import BeAlwaysChangingVisionToStrategy from 'src/content/blog/agile-change-or-adoption-turn-vision-into-strategy/images/Be-Always-Changing-vision-to-strategy.jpg';
import XMatrixKarlScotland from 'src/content/blog/agile-change-or-adoption-turn-vision-into-strategy/images/X-Matrix-Karl-Scotland.jpeg';
import WSOBSVisionForImprovement from 'src/content/blog/agile-change-or-adoption-turn-vision-into-strategy/images/WSOBS-Vision-for-Improvement.jpeg';


<Figure
  src={BeAlwaysChangingVisionToStrategy}
  alt="Be Always Changing - vision to strategy - image by Agile Pain Relief Consulting"
  caption="Be Always Changing - vision to strategy - image by Agile Pain Relief Consulting"
/>
...
<Figure
  src={XMatrixKarlScotland}
  alt="X Matrix cc license Karl Scotland"
  caption="X Matrix cc license Karl Scotland"
/>
...
<Figure
  src={WSOBSVisionForImprovement}
  alt="Worlds Smallest Online Bookstore Vision for Improvement - image by Agile Pain Relief Consulting with elements from Freepik"
  caption="Worlds Smallest Online Bookstore Vision for Improvement - image by Agile Pain Relief Consulting with elements from Freepik"
/>
