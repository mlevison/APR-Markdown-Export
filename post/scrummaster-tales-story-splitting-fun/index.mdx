...
import Photodune2996181DifferentColorsSlicedAppleXs from 'src/content/blog/scrummaster-tales-story-splitting-fun/images/photodune-2996181-different-colors-sliced-apple-xs.jpg';


<Figure
  src={Photodune2996181DifferentColorsSlicedAppleXs}
  alt="Different colors sliced apple - image licensed from Photodune"
  caption="Different colors sliced apple - image licensed from Photodune"
/>
