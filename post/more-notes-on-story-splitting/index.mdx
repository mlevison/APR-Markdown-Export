...
import Photodune8431094DoneTextAndCheckMarkXs from 'src/content/blog/more-notes-on-story-splitting/images/photodune-8431094-done-text-and-check-mark-xs.jpg';


<Figure
  src={Photodune8431094DoneTextAndCheckMarkXs}
  alt="Done image licensed from Photodune"
  caption="Done image licensed from Photodune"
/>
 In response to my recent [Story Splitting post](/blog/story-slicing-how-small-is-enough), I had a few questions and couple of confusions that need clearing up.
