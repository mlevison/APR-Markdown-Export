...
import ScrumAgileLeanBoardWithStickyNotesXs from 'src/content/blog/tools-tools-too/images/scrum-agile-lean-board-with-sticky-notes-xs.jpg';


<Figure
  src={ScrumAgileLeanBoardWithStickyNotesXs}
  alt="Scrum Agile Lean Sticky Notes - image licensed from Photodune"
  caption="Scrum Agile Lean Sticky Notes - image licensed from Photodune"
/>
