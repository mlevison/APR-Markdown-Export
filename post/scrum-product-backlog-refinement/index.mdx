...
import AgilePainReliefBlogIllustrationsFeb2019ProductBacklogRefinementAV11024x607 from 'src/content/blog/scrum-product-backlog-refinement/images/AgilePainRelief_BlogIllustrations_Feb2019_ProductBacklogRefinement_A_v1-1024x607.png';
import AgilePainReliefBlogIllustrationsFeb2019ProductBacklogRefinementBV11024x607 from 'src/content/blog/scrum-product-backlog-refinement/images/AgilePainRelief_BlogIllustrations_Feb2019_ProductBacklogRefinement_B_v1-1024x607.png';
...
<Figure
  src={AgilePainReliefBlogIllustrationsFeb2019ProductBacklogRefinementAV11024x607}
  alt="A Product Backlog Refinement meeting is where the Product Owner and the Development Team discuss the items at the top of the Product Backlog."
  caption="A Product Backlog Refinement meeting is where the Product Owner and the Development Team discuss the items at the top of the Product Backlog."
/>
...
<Figure
  src={AgilePainReliefBlogIllustrationsFeb2019ProductBacklogRefinementBV11024x607}
  alt="Backlog Refinement Meeting Agenda in Action"
  caption="Backlog Refinement Meeting Agenda in Action"
/>
