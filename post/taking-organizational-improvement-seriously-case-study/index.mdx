...
import ScrumAloneNotEnoughOrganizationalImprovement from 'src/content/blog/taking-organizational-improvement-seriously-case-study/images/scrum-alone-not-enough-organizational-improvement.jpg';
import RegressionRuntimeInDays from 'src/content/blog/taking-organizational-improvement-seriously-case-study/images/Regression-Runtime-in-Days.jpg';
import LongRegressionCycle from 'src/content/blog/taking-organizational-improvement-seriously-case-study/images/LongRegressionCycle.png';
import POCantStayFocused from 'src/content/blog/taking-organizational-improvement-seriously-case-study/images/PO-cant-stay-focused.jpg';


<Figure
  src={ScrumAloneNotEnoughOrganizationalImprovement}
...
<Figure
  src={RegressionRuntimeInDays}
  alt="Regression Runtime in Days"
  caption="Regression Runtime in Days"
/>
...
<Figure
  src={LongRegressionCycle}
  alt="Long Regression Cycle Casual Loop Diagram"
  caption="Long Regression Cycle Casual Loop Diagram"
/>
...
<Figure
  src={POCantStayFocused}
  alt="Product Owner Can't Stay Focused"
  caption="Product Owner Can't Stay Focused"
/>
