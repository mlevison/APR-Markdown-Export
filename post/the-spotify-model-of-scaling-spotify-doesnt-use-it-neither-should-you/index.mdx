...
import SpotifyScalingModelCreditKnibergIvarsson from 'src/content/blog/the-spotify-model-of-scaling-spotify-doesnt-use-it-neither-should-you/images/spotify-scaling-model-credit-Kniberg-Ivarsson.png';
import SpotifyModelMeme from 'src/content/blog/the-spotify-model-of-scaling-spotify-doesnt-use-it-neither-should-you/images/spotify-model-meme.png';
...
<Figure
  src={SpotifyScalingModelCreditKnibergIvarsson}
  alt="Spotify Scaling model image, credit Henrik Kniberg and Anders Ivarsson"
  caption="Spotify Scaling model image, credit Henrik Kniberg and Anders Ivarsson"
/>
 Figure 1 - The famous picture from: https://blog.crisp.se/wp-content/uploads/2012/11/SpotifyScaling.pdf\[/caption\]
...
<Figure
  src={SpotifyModelMeme}
  alt="spotify model meme"
  caption="spotify model meme"
/>
 Figure 2 from: https://medium.com/serious-scrum/you-want-to-adopt-the-spotify-model-i-dont-think-it-means-what-you-think-it-means-7df4316081f\[/caption\]
