...
import HighPerformanceTeamsGame from 'src/content/blog/welcome-to-the-high-performance-teams-game/images/High-Performance-Teams-Game.jpg';
import 88x31 from 'src/content/blog/welcome-to-the-high-performance-teams-game/images/88x31.png';


<Figure
  src={HighPerformanceTeamsGame}
  alt="High Performance Teams Game Banner"
  caption="High Performance Teams Game Banner"
/>
...
<Figure
  ...
  caption="Creative Commons License Icon"
/>
](https://creativecommons.org/licenses/by-sa/4.0/) High-Performance Teams Game by [Mark Levison - Agile Pain Relief Consulting](https://agilepainrelief.com) is licensed under a [Creative Commons Attribution-ShareAlike 4.0 International License](external:https://creativecommons.org/licenses/by-sa/4.0/).
