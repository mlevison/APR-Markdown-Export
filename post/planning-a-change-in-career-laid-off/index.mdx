...
import OutOfWorkXs from 'src/content/blog/planning-a-change-in-career-laid-off/images/out-of-work-xs.jpg';


<Figure
  src={OutOfWorkXs}
  alt="Businessman with clipboard: out of work - image licensed from Photodune"
  caption="Businessman with clipboard: out of work - image licensed from Photodune"
/>
