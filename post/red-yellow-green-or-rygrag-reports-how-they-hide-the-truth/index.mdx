...
import TrafficLightAll from 'src/content/blog/red-yellow-green-or-rygrag-reports-how-they-hide-the-truth/images/traffic_light_all.png';
import BurnupChartStoriesCompleted from 'src/content/blog/red-yellow-green-or-rygrag-reports-how-they-hide-the-truth/images/burnup-chart-stories-completed.jpg';


<Figure
  src={TrafficLightAll}
  alt="Traffic lights image by www.openclipart.org"
  caption="Traffic lights image by www.openclipart.org"
/>
...
<Figure
  src={BurnupChartStoriesCompleted}
  alt="Example of a burnup chart, including lines for stories completed and confidence lines"
  caption="Example of a burnup chart, including lines for stories completed and confidence lines"
/>
