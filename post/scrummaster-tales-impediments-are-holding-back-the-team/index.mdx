...
import StopSignFreePik from 'src/content/blog/scrummaster-tales-impediments-are-holding-back-the-team/images/stop-sign-FreePik.jpg';


<Figure
  src={StopSignFreePik}
  alt="Stop Sign. Image by FreePik"
  caption="Stop Sign. Image by FreePik"
/>
