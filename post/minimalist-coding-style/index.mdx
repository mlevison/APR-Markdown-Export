...
import ModernOfficeXs from 'src/content/blog/minimalist-coding-style/images/modern-office-xs.jpg';


<Figure
  src={ModernOfficeXs}
  alt="modern office - image licensed from Photodune"
  caption="modern office - image licensed from Photodune"
/>
 “Perfection is achieved, not when there is nothing more to add, but when there is nothing left to take away” - **[Antoine de Saint  Exupéry](external:https://en.wikipedia.org/wiki/Antoine_de_Saint_Exup%C3%A9ry)**. If you’ve ever invited me do some pair programming with you, you probably have a good idea what this quote is all about. I often wind up asking questions like:
