...
After the stress of the [last release](/blog/scrummaster-tales-overtime-on-a-scrum-team-is-an-unhealthy-sign), Steve and his team are slowly paying down the [technical debt (mess)](https://www.infoq.com/articles/technical-debt-levison/) they created. They maintain a technical debt backlog, knocking off a few items every sprint in addition to the work they do creating new features. If they keep this up it will take only another three to four months before they’re as productive as they were before the release.
