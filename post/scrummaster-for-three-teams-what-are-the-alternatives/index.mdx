...
import PulledInManyDirectionsSmall from 'src/content/blog/scrummaster-for-three-teams-what-are-the-alternatives/images/PulledInManyDirections-small.jpg';


<Figure
  src={PulledInManyDirectionsSmall}
  alt="Pulled In Many Directions - by FreeImages.com"
  caption="Pulled In Many Directions - by FreeImages.com"
/>
