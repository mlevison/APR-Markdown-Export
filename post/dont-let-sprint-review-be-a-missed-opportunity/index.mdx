...
import APRStoryOfASprintBoard121024x576 from 'src/content/blog/dont-let-sprint-review-be-a-missed-opportunity/images/APR-Story-of-a-Sprint-board-12-1024x576.png';
import SbEWSOBSBuyerReviewsUnverifiedBuyer from 'src/content/blog/dont-let-sprint-review-be-a-missed-opportunity/images/SbE-WSOBS-buyer-reviews-unverified-buyer.png';
import SbEWSOBSBuyerReviewsHelpfulVote from 'src/content/blog/dont-let-sprint-review-be-a-missed-opportunity/images/SbE-WSOBS-buyer-reviews-helpful-vote.png';
...
<Figure
  src={APRStoryOfASprintBoard121024x576}
  alt="Illustration of Scrum team meeting with shareholders, with the Product Owner moderating discussion."
  caption="Illustration of Scrum team meeting with shareholders, with the Product Owner moderating discussion."
/>
...
<Figure
  src={SbEWSOBSBuyerReviewsUnverifiedBuyer}
  alt="Placeholder example of an online review with a 1-5 star rating"
  caption="Placeholder example of an online review with a 1-5 star rating"
/>
...
<Figure
  src={SbEWSOBSBuyerReviewsHelpfulVote}
  alt="A placeholder example of an online review from a verified buyer of a product"
  caption="A placeholder example of an online review from a verified buyer of a product"
/>
