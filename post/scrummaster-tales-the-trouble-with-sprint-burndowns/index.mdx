...
import SprintBurndownEstimateHrsRemaining from 'src/content/blog/scrummaster-tales-the-trouble-with-sprint-burndowns/images/SprintBurndownEstimateHrsRemaining.png';
import SprintBurndownNumberStoriesRemaining from 'src/content/blog/scrummaster-tales-the-trouble-with-sprint-burndowns/images/SprintBurndownNumberStoriesRemaining.png';


<Figure
  src={SprintBurndownEstimateHrsRemaining}
  alt="SprintBurndownEstimateHrsRemaining"
  caption="SprintBurndownEstimateHrsRemaining"
/>
It’s six Sprints after the “[Overtime/Disastrous Release](/blog/scrummaster-tales-overtime-on-a-scrum-team-is-an-unhealthy-sign)”, which set the team back by several months. During the current Sprint Planning, the Team committed to completing the following nine User Stories:
...
<Figure
  src={SprintBurndownNumberStoriesRemaining}
  alt="Sprint Burndown Number of Stories Remaining"
  caption="Sprint Burndown Number of Stories Remaining"
/>
