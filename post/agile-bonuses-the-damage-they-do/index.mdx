...
import BonusesAntiPatternCLD1 from 'src/content/blog/agile-bonuses-the-damage-they-do/images/Bonuses-anti-pattern-CLD-1.png';
import BonusesAntiPatternCLD2 from 'src/content/blog/agile-bonuses-the-damage-they-do/images/Bonuses-anti-pattern-CLD-2.png';
import BonusesAntiPatternCLD from 'src/content/blog/agile-bonuses-the-damage-they-do/images/Bonuses-anti-pattern-CLD.png';
...
<Figure
  src={BonusesAntiPatternCLD}
  alt="Bonuses anti pattern CLD"
  caption="Bonuses anti pattern CLD"
/>
