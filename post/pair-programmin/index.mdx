...
import CasualExecutivesWorkingTogetherAtAMeetingWithLaptopXs from 'src/content/blog/pair-programmin/images/casual-executives-working-together-at-a-meeting-with-laptop-xs.jpg';
...
/>
 Ok so I’m about a month behind. Over on [Coding Horror Jeff Atwood](external:https://blog.codinghorror.com/pair-programming-vs-code-reviews/) asked “**I can't help wondering if pair programming is nothing more than code review on steroids**”. In a word ‘No’.
