...
import Road44143640 from 'src/content/blog/scrummaster-tales-stuck-waiting-for-other-teams/images/road-44143_640.png';
import ScrumMasterTalesStuckWaitingForOtherTeamsDataTable from 'src/content/blog/scrummaster-tales-stuck-waiting-for-other-teams/images/ScrumMaster_Tales_-_Stuck_Waiting_for_Other_Teams_data_table.jpg';
import ScrumMasterTalesStuckWaitingForOtherTeamsCFDChart from 'src/content/blog/scrummaster-tales-stuck-waiting-for-other-teams/images/ScrumMaster_Tales_-_Stuck_Waiting_for_Other_Teams_CFD_chart.jpg';


<Figure
  src={Road44143640}
  alt="Speed Bump Sign - free image from Pixabay.com"
  caption="Speed Bump Sign - free image from Pixabay.com"
/>
...
<Figure
  src={ScrumMasterTalesStuckWaitingForOtherTeamsDataTable}
  alt="ScrumMaster_Tales_-_Stuck_Waiting_for_Other_Teams_data_table"
  caption="ScrumMaster_Tales_-_Stuck_Waiting_for_Other_Teams_data_table"
/>
...
<Figure
  src={ScrumMasterTalesStuckWaitingForOtherTeamsCFDChart}
  alt="ScrumMaster_Tales_-_Stuck_Waiting_for_Other_Teams_CFD_chart"
  caption="ScrumMaster_Tales_-_Stuck_Waiting_for_Other_Teams_CFD_chart"
/>
