...
import ScrumAloneNotEnoughKanban from 'src/content/blog/kanban-portfolio-view/images/scrum-alone-not-enough-kanban.jpg';
import KanbanPortfolioView2024Basic21024x592 from 'src/content/blog/kanban-portfolio-view/images/Kanban-Portfolio-View-2024-Basic2-1024x592.jpg';


<Figure
  src={ScrumAloneNotEnoughKanban}
  alt="Beyond Scrum: Scrum Alone Is Not Enough - portfolio kanban"
  caption="Beyond Scrum: Scrum Alone Is Not Enough - portfolio kanban"
/>
...
<Figure
  src={KanbanPortfolioView2024Basic21024x592}
  alt=""
  caption=""
/>
