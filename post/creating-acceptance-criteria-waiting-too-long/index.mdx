...
import Photodune8431094DoneTextAndCheckMarkXs from 'src/content/blog/creating-acceptance-criteria-waiting-too-long/images/photodune-8431094-done-text-and-check-mark-xs.jpg';
...
/>
 The recent [Backlog Refinement](/blog/scrummaster-tales-story-splitting-fun) session helped split the upcoming User Stories.
