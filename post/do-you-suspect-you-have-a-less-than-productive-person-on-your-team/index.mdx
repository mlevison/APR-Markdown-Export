...
import TypewriterXs from 'src/content/blog/do-you-suspect-you-have-a-less-than-productive-person-on-your-team/images/typewriter-xs.jpg';


<Figure
  src={TypewriterXs}
  alt="typewriter - image licensed from Photodune"
  caption="typewriter - image licensed from Photodune"
/>
