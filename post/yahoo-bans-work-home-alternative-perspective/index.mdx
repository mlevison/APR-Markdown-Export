...
import TelephoneXs from 'src/content/blog/yahoo-bans-work-home-alternative-perspective/images/telephone-xs.jpg';


<Figure
  src={TelephoneXs}
  alt="telephone - image licensed from Photodune"
  caption="telephone - image licensed from Photodune"
/>
