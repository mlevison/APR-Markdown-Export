...
import BigBitSmallNibble from 'src/content/blog/reinventing-existing-products-big-bite-vs-small-nibble-rewrites/images/big-bit-small-nibble.jpg';


<Figure
  src={BigBitSmallNibble}
  alt="Big Bite Small Nibble - images licensed from Unsplash: Alec Weir, Bonnie Kittle"
  caption="Big Bite Small Nibble - images licensed from Unsplash: Alec Weir, Bonnie Kittle"
/>
