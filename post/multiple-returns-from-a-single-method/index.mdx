...
import DoorwayXs from 'src/content/blog/multiple-returns-from-a-single-method/images/doorway-xs.jpg';


<Figure
  src={DoorwayXs}
  alt="Doorway - image licensed from Photodune"
  caption="Doorway - image licensed from Photodune"
/>
 It’s funny just about the only thing anyone really objected to from my recent post on [Minimal Coding Style](/blog/minimalist-coding-style) was multiple return statements.
