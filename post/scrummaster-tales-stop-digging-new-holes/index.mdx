...
import Photodune9444702YellowWorkingSignXs from 'src/content/blog/scrummaster-tales-stop-digging-new-holes/images/photodune-9444702-yellow-working-sign-xs.jpg';
import StoryTaskBoard from 'src/content/blog/scrummaster-tales-stop-digging-new-holes/images/Story-Task-board.png';
import SonarScreenshot from 'src/content/blog/scrummaster-tales-stop-digging-new-holes/images/Sonar-screenshot.png';


<Figure
  src={Photodune9444702YellowWorkingSignXs}
  alt="Yellow vector working sign - image licensed from Photodune"
  caption="Yellow vector working sign - image licensed from Photodune"
/>
 The first law of holes is “When you’re in one, stop digging”. [In the last sprint](/blog/scrummaster-tales-technical-debt-is-slowing-the-team) the team discovered that they’re in a hole – in this case they had dug themselves into technical debt.
...
<Figure
  src={StoryTaskBoard}
  alt="Scrum Story / Task board"
  caption="Scrum Story / Task board"
/>
...
<Figure
  src={SonarScreenshot}
  alt="Screenshot from Sonar's own Nemo"
  caption="Screenshot from Sonar's own Nemo"
/>
