...
import TuckmansModel from 'src/content/blog/in-agile-where-change-is-valued-why-is-a-stable-team-so-important/images/Tuckmans-Model.jpg';
import UnstableTeamsTuckmanStages from 'src/content/blog/in-agile-where-change-is-valued-why-is-a-stable-team-so-important/images/Unstable-Teams-Tuckman-stages.jpg';
...
<Figure
  src={TuckmansModel}
  alt="Tuckman's Model of Team Formation"
  caption="Tuckman's Model of Team Formation"
/>
