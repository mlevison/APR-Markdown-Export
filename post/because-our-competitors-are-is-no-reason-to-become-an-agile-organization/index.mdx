...
import CynefinChart from 'src/content/blog/because-our-competitors-are-is-no-reason-to-become-an-agile-organization/images/cynefin-chart.jpg';
...
<Figure
  src={CynefinChart}
  alt="Cynefin Framework - image by Agile Pain Relief Consulting"
  caption="Cynefin Framework - image by Agile Pain Relief Consulting"
/>
