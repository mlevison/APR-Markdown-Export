...
import Construction1Freepik from 'src/content/blog/software-development-is-not-a-form-of-construction/images/construction1.Freepik.jpg';


<Figure
  src={Construction1Freepik}
  alt="icon of a person in overalls with a wrench, with various acronyms of well-known scripting and programming languages in the background"
  caption="icon of a person in overalls with a wrench, with various acronyms of well-known scripting and programming languages in the background"
/>
