...
- [Kanban vs Scrum: best Agile frameworks for the age of uncertainty](external:https://www.mindk.com/blog/kanban-vs-scrum/)
- [Scrumban – Blending Agile, Scrum and Kanban into a methodology that works for you](external:https://kanbanzone.com/2017/scrumban-blending-agile-scrum-kanban/)
- [Scrum vs Kanban - Two Agile Teams Go Head-to-Head](external:https://www.youtube.com/watch?v=HNd1_irOL5k) (Youtube)
- [Dive into Kanban (6) - Scrum vs Kanban](external:http://www.thinkingincrowd.me/2015/10/08/Dive-into-Kanban-6-Scrum-vs-Kanban/) - _I don't agree with many of the authors assertions, however the article is good at provoking deeper thought_
- [When Kanban is the Better Choice](external:https://www.mountaingoatsoftware.com/blog/when-kanban-is-the-better-choice)
</HighlightBox>
