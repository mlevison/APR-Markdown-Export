...
import HowDoesUtilizationImpactLeadTimeOfWorkTroyMagennis1024x505 from 'src/content/glossary/resource-utilization-trap/images/How_Does_Utilization_Impact_Lead-time_of_Work____Troy_Magennis-1024x505.jpg';
...
<Figure
  ...
  caption=""
/>
 From https://observablehq.com/@troymagennis/how-does-utilization-impact-lead-time-of-work\[/caption\]
...
- - - [The Economic Impact of High System Utilization](external:https://observablehq.com/@troymagennis/the-economic-impact-of-high-system-utilization)
        - [The Famous 'Resource Utilization'​ Trap!!](external:https://www.linkedin.com/pulse/famous-resource-tilization-trap-jayaram-hegde/)
        - ["Full Resource Utilisation"​](external:https://www.linkedin.com/pulse/full-resource-utilisation-trond-hjorteland/)
        - [How Does Utilization Impact Lead-time of Work?](external:https://observablehq.com/@troymagennis/how-does-utilization-impact-lead-time-of-work)
        - [How Kicksaw Killed Utilization](external:https://www.kicksaw.com/blog/how-kicksaw-killed-utilization)
        - [The resource utilization trap](external:https://www.youtube.com/watch?v=CostXs2p6r0) - Henrik Kniberg explains how it impacts our ability to deliver and what we can do about it (video)
        - [Scrum Master tactics: Escaping the resource utilization trap](external:https://medium.com/@stephan_vlieland/scrum-master-tactics-escaping-the-resource-utilization-trap-f169a79547)
</HighlightBox>

<HighlightBox heading="Related Books" variant="relatedBooks">:

[_The Principles of Product Development Flow: Second Generation Lean Product Development_](external:https://www.amazon.ca/Principles-Product-Development-Flow-Generation-ebook/dp/B00K7OWG7O/&tag=notesfromatoo-20) - Donald Reinertsen
</HighlightBox>
