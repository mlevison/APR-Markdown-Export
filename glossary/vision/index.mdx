...
import KanerDiagramOfParticipationDivergentThinking1024x557 from 'src/content/glossary/vision/images/Kaner-Diagram-of-Participation-Divergent-Thinking-1024x557.jpg';
...
[Future Perspective for Change: Why Backcasting Helps Get You Where You Want to Be](blog/future-perspective-for-organizational-change) - this tool can be used for setting a vision for organizational change, in addition to creating a vision for a product.

<HighlightBox heading="Resource Links" variant="resourceLinks">
- [8 Tips for Creating a Compelling Product Vision](external:https://www.romanpichler.com/blog/tips-for-writing-compelling-product-vision/)
- [Agile Product Planning: Vision, Strategy, and Tactics](external:https://www.romanpichler.com/blog/agile-product-planning-vision-strategy-tactics/)
- [All-hands Team Memo March 2024](external:https://missiveapp.com/blog/memo-1)
- [Celebration-5W](external:https://www.agendashift.com/resources/celebration-5w) - Agendashift Discovery exercise
- [Common Product Vision Board Mistakes](external:https://www.romanpichler.com/blog/common-product-vision-board-mistakes/)
- [Design The Box](external:https://gamestorming.com/design-the-box/)
- [How to Build a Product Vision Box and Clarify Your Software Goals](external:https://reqtest.com/agile-blog/how-to-build-a-product-vision-box-and-clarify-your-software-goals/)
- [How to Create a Future Focused Vision in 5 Steps](external:https://spitzercoaching.com/how-to-create-a-future-focused-vision-in-5-steps/)
- [How to get your project started on the right foot](external:https://www.kbp.media/portfolio/start-a-project/)
- [My Innovation Games Project Box experience](external:https://agilepmo.ca/tag/product-box/)
- [Product Canvas – beyond the Product Backlog](external:https://www.romanpichler.com/blog/the-product-canvas/)
- [Product Vision Canvas](external:https://www.5dvision.com/agile-product-frameworks/product-vision-canvas/)
- [Product Vision FAQ](external:https://www.svpg.com/product-vision-faq/)
- [Product Vision FAQs](external:https://www.romanpichler.com/blog/product-vision-faqs/) - Roman Pichler
- [The Product Vision Board](external:https://www.romanpichler.com/blog/the-product-vision-board/)
- Remember the Future - from [Design Thinking Toolkit](external:https://spin.atomicobject.com/2017/11/30/design-thinking-remember-future/) and (originally from the book Innovation Games) - good for creating vision for teams that are involved in doing organizational change work as well
- [Remembering the Future](external:https://medium.com/frameplay/remembering-the-future-5894d0d11082)
- [Remote creation of an Agile vision](external:https://blog.crisp.se/2020/03/20/mattiasskarin/remote-creation-of-an-agile-vision-for-the-future)
- [Strategy and the Importance of Vision](external:https://www.designative.info/2021/05/09/strategy-importance-of-vision/)
</HighlightBox>
