...
Read the article "[Agile Teams: Don’t use happiness metrics, measure Team Morale"](external:https://medium.com/the-liberators/agile-teams-dont-use-happiness-metrics-measure-team-morale-3050b339d8af) by Christiaan Verwijs for more depth.
...
- [Agile Teams: Don’t use happiness metrics, measure Team Morale](external:https://medium.com/the-liberators/agile-teams-dont-use-happiness-metrics-measure-team-morale-3050b339d8af) This blog post has a surprising degree of rigour and is the original source of Morale in the Agile Community.
- [How I Measure Scrum Team Morale](external:https://medium.com/serious-scrum/how-i-measure-scrum-team-morale-a8220f0a90d0) - similar ideas, the questions may not have the proven rigour of the others
- [Agile Team Health & Morale Checks](external:https://www.andycleff.com/2021/02/agile-team-health-check-models/) offers every team health check you could imagine. Some good, some I wouldn't recommend.
</HighlightBox>
