...
- \[1\] [Building the Emotional Intelligence of Groups](external:https://hbr.org/2001/03/building-the-emotional-intelligence-of-groups)
- [Leveraging Diversity to Enhance Cybersecurity](external:https://www.infoq.com/articles/diversity-cybersecurity/)
- [When Diversity Delivers—and When It Doesn’t](external:https://spectrum.ieee.org/when-diversity-deliversand-when-it-doesnt)
- [Why thought diversity is important for agile teams](external:https://miro.com/blog/thought-diversity-agile-teams/)

### Examples of how it helped:

- [The impact of diversity on agile organizations](external:https://www.linkedin.com/pulse/impact-diversity-agile-organizations-christin-loehr)
- [Why diversity in teams is the key to customer success](external:https://www.atlassian.com/blog/add-ons/diversity-teams-key-customer-success)

### Examples of where lack of diversity hurt:

- [Ignoring Diversity Hurts Tech Products and Ventures](external:https://ecorner.stanford.edu/articles/ignoring-diversity-hurts-tech-products-and-ventures/)
- [Lack of diversity increases risk of tech product failures](external:https://www.ft.com/content/0ef656a8-cd8a-11e8-8d0b-a6539b949662)
- [Photo Algorithms ID White Men Fine—Black Women, Not So Much](external:https://www.wired.com/story/photo-algorithms-id-white-men-fineblack-women-not-so-much/)
