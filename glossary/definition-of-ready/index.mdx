...
import DefinitionOfReadyHarmfulHelpfulExamples1024x538 from 'src/content/glossary/definition-of-ready/images/Definition-of-Ready-harmful-helpful-examples-1024x538.jpg';
import LeadTimeCycleTimeKanbanBoardExample from 'src/content/glossary/definition-of-ready/images/Lead-time-Cycle-time-kanban-board-example.png';
...
- [Definition of Ready](external:https://blog.gdinwiddie.com/2014/03/27/definition-of-ready/) (by George Dinwiddie)
- [Definition of Ready](external:https://sites.google.com/a/scrumplop.org/published-patterns/value-stream/product-backlog/definition-of-ready) (by Published Patterns)
- [Definition of Ready: A double edged sword](external:https://stefanroock.wordpress.com/2012/08/04/definition-of-ready-a-double-edged-sword/)
- [Definition of Ready — Dangerous or Necessary?](external:https://medium.com/serious-scrum/definition-of-ready-dangerous-or-necessary-891e586efd0d)
- [Definition of Ready is Evil](external:https://mike-brewer.medium.com/definition-of-ready-is-evil-3aa50bb29ca5)
- [Definition of Ready: What It Is and Why It's Dangerous](external:https://www.mountaingoatsoftware.com/blog/the-dangers-of-a-definition-of-ready)
- [Is “Definition of Ready” part of Scrum?](external:https://collaborativeleadershipteam.com/blog/is-definition-of-ready-part-of-scrum)
- [A Question of Handoffs & Queues](external:https://www.agilemagic.ca/blog/handoffs-and-queues)
</HighlightBox>
